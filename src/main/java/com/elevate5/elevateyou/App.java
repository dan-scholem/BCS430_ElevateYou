    ...
    public static void connect(){
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            try {
                ...
                stmt.executeUpdate("create table users (user_id integer not null primary key, " +
                ...
                stmt.executeUpdate("create table profile (profile_id integer not null primary key, " +
                ...
                stmt.executeUpdate("create table food_consumption (foodentry_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table workouts (workout_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table workout_activity (activity_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table health_metrics (metric_id integer not null primary key, " +
                        "user_id integer not null, " +
                        "metric_date date not null, " +
                        "user_weight decimal not null, " +
                ...
                stmt.executeUpdate("create table user_goals (goals_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table medications (medication_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table sleep_record (sleep_id int not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table motivation_quotes (quote_id integer not null primary key, " +
                ...
                stmt.executeUpdate("create table journal_entries (entry_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table appointment_log (appointment_id integer not null primary key, " +
                        "user_id integer not null, " +
                ...
                stmt.executeUpdate("create table reminders (reminder_id integer not null primary key, " +
                        "user_id integer not null, " +
