...
public class LandingView {
    ...
    public void initialize() {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/Dashboard.fxml"));
    ...
    protected void calendarButtonClick() throws IOException {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/CalendarView.fxml"));
    ...
    protected void foodButtonClick() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/CaloriesWaterIntake.fxml"));
    ...
    protected void journalButtonClick() throws IOException {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/PersonalJournal.fxml"));
    ...
    public void appointmentButtonClick() throws IOException {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/AppointmentView.fxml"));
    ...
    public void sleepButtonClick() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/Sleep.fxml"));
    ...
    protected void quoteaffirmationButtonClick() throws IOException {
        ...
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/elevate5/elevateyou/QuotesAffirmations.fxml"));
